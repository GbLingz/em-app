                    ...
                    <Icon className={`text-emBlue`} fontSize={fn.rem(28)} icon='line-md:edit' />
                      ...
                      <Menu.Item>
                        ...
                        >
                          <div className={`flex items-center gap-4`}>
                          <div>
                  <Icon className={`text-emBlue`} fontSize={fn.rem(28)} icon='mingcute:notification-fill' />
                          </div>
                          Notification
                          </div>
                        </Link>
                      ...
                      <div className={`flex items-center gap-4`}>
                      <div>
                      <Icon className={`text-emRed`} fontSize={fn.rem(28)} icon="solar:logout-2-line-duotone" />
                      </div>
                      Log Out
                      </div>
                      </Link>
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={classNames(
                    item.current
                      ? " text-emBlue"
                      : "text-gray-300 hover:text-emBlue",
